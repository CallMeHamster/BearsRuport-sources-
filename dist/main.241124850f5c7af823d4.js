...
function closeOnButton() {
  document.querySelector('.cardClose').addEventListener('click', function () {
    ...
    bigCard.classList.remove('bigCard--active');
    setTimeout(function () {
      return bigCard.removeChild(bigCardWrapper);
    }, 500);
    document.body.classList.remove('blur');
  });
...
function filterContentDrop() {
  var dropDownButton = document.querySelector('.requests__filter');
  var filter = document.querySelector('.requests__filter-content');
...
/******/ })()
;
//# sourceMappingURL=main.241124850f5c7af823d4.js.map