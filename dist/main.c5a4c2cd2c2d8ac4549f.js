...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "clickOnBothFilter": () => (/* binding */ clickOnBothFilter)
/* harmony export */ });
...
function reserveFilter(checkBox, acceptedNode, rejectedNode) {
  checkBox.addEventListener('click', function () {
    ...
    if (!checkBox.classList.contains("".concat(checkBox.classList[0], "--active"))) {
      checkBox.classList.add("".concat(checkBox.classList[0], "--active"));
      ...
      if (!acceptedNode.classList.contains("".concat(acceptedNode.classList[1], "--active")) && !rejectedNode.classList.contains("".concat(rejectedNode.classList[1], "--active"))) {
        ...
        (0,_reRender__WEBPACK_IMPORTED_MODULE_2__.cardFunctional)();
      } else if (acceptedNode.classList.contains("".concat(acceptedNode.classList[1], "--active")) && !rejectedNode.classList.contains("".concat(rejectedNode.classList[1], "--active"))) {
...
function filterContentDrop(button, buttonChildren) {
  var arrow = document.querySelector('.requests__button-arrow');
  button.addEventListener('click', function () {
    if (!button.classList.contains("".concat(button.classList[0], "--active"))) {
      button.classList.add("".concat(button.classList[0], "--active"));
      arrow.classList.add('requests__button-arrow--active');
      buttonChildren.classList.add("".concat(buttonChildren.classList[0], "--active"));
    } else {
  ...
  window.addEventListener('click', function (e) {
    if (button.classList.contains("".concat(button.classList[0], "--active"))) {
      var target = e.target;
      if (!target.closest(".".concat(buttonChildren.classList[0])) && !target.closest(".".concat(button.classList[0]))) {
        button.classList.remove(button.classList[1]);
...
function acceptedAndRejectedFilters(firstNode, secondNode, reserveCheckbox) {
  var promo = document.querySelector('.requests__promo');
  firstNode.addEventListener('click', function () {
    ...
    if (firstNode.classList.contains("".concat(firstNode.classList[1], "--active"))) {
      var structure = _fetchData__WEBPACK_IMPORTED_MODULE_0__.bearsArr.filter(function (item) {
        return !item.state;
      }).reduce(function (acc, item) {
        return acc + (0,_usualCard__WEBPACK_IMPORTED_MODULE_1__.structureCard)(item);
      ...
      var name = firstNode.classList[0];
      var slicePoint = name.indexOf('-') + 2;
      firstNode.classList.add("".concat(firstNode.classList[1], "--active"));
      ...
      var bears = _fetchData__WEBPACK_IMPORTED_MODULE_0__.bearsArr.filter(function (item) {
        return item.state === name.slice(slicePoint);
      });
      var _structure3 = bears.reduce(function (acc, item) {
        return acc + (0,_usualCard__WEBPACK_IMPORTED_MODULE_1__.structureCard)(item);
      }, '');
      requests.innerHTML = _structure3;
...
function clickOnBothFilter() {
  var desktopBtn = document.querySelector('.requests__filter');
  var desktopBtnChildren = document.querySelector('.requests__filter-content');
  var hamburgerBtn = document.querySelector('.hamburger');
  var hamburgerChildren = document.querySelector('.hamburgerFilter');
  var desktopReserve = document.querySelector('.requests__checkbox');
  var desktopAccepted = document.querySelector('.requests__filter--accepted');
  var desktopRejected = document.querySelector('.requests__filter--rejected');
  var mobileReserve = document.querySelector('.hamburgerFilter__reserve');
  var mobileAccepted = document.querySelector('.hamburgerFilter--accepted');
  var mobileRejected = document.querySelector('.hamburgerFilter--rejected');
...
function closeOnButton() {
  document.querySelector('.cardClose').addEventListener('click', function () {
    var bigCardWrapper = document.querySelector('.cardWrapper');
    bigCard.classList.remove('bigCard--active');
    setTimeout(function () {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "bearsArr": () => (/* binding */ bearsArr),
/* harmony export */   "getBearsData": () => (/* binding */ getBearsData)
/* harmony export */ });
...
function getBearsData() {
  return _getBearsData.apply(this, arguments);
}
function _getBearsData() {
  _getBearsData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response, datas;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return fetch('https://private-9d5e37a-testassignment.apiary-mock.com/get-bears');
          case 3:
          ...
          case 6:
            datas = _context.sent;
            datas.results.data.filter(function (item) {
              return !item.state;
            }).forEach(function (item) {
              return bearsArr.push(item);
            });
            _context.next = 13;
            break;
          case 10:
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "cardFunctional": () => (/* binding */ cardFunctional)
/* harmony export */ });
/* harmony import */ var _fetchData__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fetchData */ "./src/js/fetchData.js");
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ../fonts/Raleway/static/Raleway-Regular.ttf */ "./src/fonts/Raleway/static/Raleway-Regular.ttf"), __webpack_require__.b);
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
var ___CSS_LOADER_URL_REPLACEMENT_0___ = _node_modules_css_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_2___default()(___CSS_LOADER_URL_IMPORT_0___);
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@font-face {\n  font-family: generalFont;\n  src: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n}\n* {\n  box-sizing: border-box;\n  margin: 0;\n  font-family: generalFont;\n  font-style: normal;\n}\n\nbody {\n  background-color: #F2F2F2;\n}\n\n.blur:before {\n  content: \"\";\n  position: fixed;\n  width: 100%;\n  height: 100%;\n  -webkit-backdrop-filter: blur(40.7742px);\n          backdrop-filter: blur(40.7742px);\n  z-index: 1;\n}\n\n.bearName {\n  color: #3F3F3F;\n}\n.bearName--reserve {\n  color: #FFFFFF;\n}\n\n.bearTypeNGender {\n  color: #767676;\n}\n.bearTypeNGender--reserve {\n  color: #E7E7E7;\n}\n\n.reserveText {\n  position: absolute;\n  color: #58FFB5;\n}\n\n.btn--accept {\n  width: 180px;\n  height: 32px;\n  margin-bottom: 10px;\n  border: 16px;\n  border-radius: 16px;\n  font-size: 14px;\n  transition: 0.3s;\n  cursor: pointer;\n  background-color: #58FFB5;\n  color: #208085;\n}\n.btn--accept:hover {\n  background-color: #FEED7E;\n}\n\n.btn--reject {\n  width: 180px;\n  height: 32px;\n  margin-bottom: 10px;\n  border: 16px;\n  border-radius: 16px;\n  font-size: 14px;\n  transition: 0.3s;\n  cursor: pointer;\n  background-color: #208085;\n  color: #FFFFFF;\n}\n.btn--reject:hover {\n  background-color: #0E4447;\n}\n.btn--reject--reserve {\n  border: 2px solid white;\n}\n\nheader {\n  padding-top: 13px;\n  padding-left: 130px;\n  height: 60px;\n  background-color: #0E4447;\n}\nheader img {\n  display: inline-block;\n}\n\n.hamburger {\n  display: none;\n  position: fixed;\n  top: 20px;\n  left: 90%;\n}\n.hamburger span {\n  display: block;\n  height: 2px;\n  width: 20px;\n  background-color: black;\n  margin-bottom: 2px;\n  transition: 0.5s all;\n}\n.hamburger--active span:nth-child(1) {\n  transform: translateY(7px) rotate(-45deg);\n}\n.hamburger--active span:nth-child(2) {\n  display: none;\n}\n.hamburger--active span:nth-child(3) {\n  transform: translateY(3px) rotate(45deg);\n}\n.hamburgerFilter {\n  display: none;\n  flex-direction: column;\n  align-items: center;\n  position: fixed;\n  width: 240px;\n  top: 0;\n  margin-left: -100%;\n  height: 101%;\n  font-size: 16px;\n  background-color: rgba(0, 0, 0, 0.9);\n  transition: visibility, margin-left 0.5s;\n  z-index: 2;\n}\n.hamburgerFilter--active {\n  margin-left: -5px;\n}\n.hamburgerFilter__main {\n  position: absolute;\n  top: 10px;\n  color: #FEED7E;\n  border: 2px solid;\n  padding: 0 7%;\n  font-size: 20px;\n}\n.hamburgerFilter--accepted {\n  position: relative;\n  margin: 50% 0 30% 0;\n}\n.hamburgerFilter--accepted::before {\n  content: \"\";\n  display: block;\n  position: absolute;\n  top: -5px;\n  left: -10%;\n  width: 2px;\n  height: 100px;\n  background-color: white;\n}\n.hamburgerFilter__node {\n  color: #E7E7E7;\n}\n.hamburgerFilter__node--active {\n  color: #FEED7E;\n}\n.hamburgerFilter__reserve {\n  color: #E7E7E7;\n  margin-top: 40%;\n  font-size: 18px;\n}\n.hamburgerFilter__reserve--active {\n  color: #FEED7E;\n}\n\n.header__text {\n  display: inline-block;\n  position: absolute;\n  color: #F4F4F4;\n  margin-left: 12px;\n  font-size: 24px;\n}\n\n.requests {\n  min-height: calc(100vh - 100px);\n}\n\n.container {\n  display: flex;\n  flex-wrap: wrap;\n  padding: 42px 240px 0 240px;\n}\n\n.requests__cards {\n  margin-top: 39px;\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: center;\n}\n\n.requests__cards-card {\n  height: 380px;\n  width: 220px;\n  margin-right: 20px;\n  margin-bottom: 20px;\n  background-color: #FFFFFF;\n  border-radius: 6px 6px 6px 6px;\n  text-decoration: none;\n  CURSOR: pointer;\n  border-color: white;\n  transition: 0.5s;\n}\n.requests__cards-card--inactive {\n  display: none;\n}\n.requests__cards-card:hover {\n  border: 1px solid #208085;\n}\n.requests__cards-card--reserve {\n  background: #208085;\n}\n\n.requests__cards-imgBlock {\n  position: relative;\n  height: 180px;\n  width: 100%;\n  overflow: hidden;\n  border-radius: 6px 6px 0 0;\n}\n.requests__cards-imgBlock img {\n  height: 100%;\n  width: 100%;\n}\n.requests__cards-imgBlock--reserve::before {\n  content: \"\";\n  position: absolute;\n  width: 100%;\n  height: 100%;\n  background: linear-gradient(180deg, #208085 0%, rgba(32, 128, 133, 0.0001) 100%);\n}\n\n.requests__cards-descr {\n  text-align: center;\n  padding-top: 20px;\n}\n\n.requests__reserveText {\n  top: 8%;\n  left: 25%;\n  font-size: 18px;\n}\n\n.requests__bearName {\n  color: #3F3F3F;\n  font-size: 18px;\n  margin-bottom: 9px;\n}\n.requests__bearName--reserve {\n  color: #FFFFFF;\n  margin-bottom: 9px;\n}\n\n.requests__bearTypeNGender {\n  color: #767676;\n  font-size: 14px;\n}\n.requests__bearTypeNGender--reserve {\n  color: #E7E7E7;\n}\n\n.requests__cards-btns {\n  display: flex;\n  justify-content: center;\n  flex-wrap: wrap;\n  margin-top: 24px;\n}\n\n.wrapperForNavigation {\n  display: flex;\n  justify-content: space-between;\n  width: 100%;\n}\n\n.requests__promo {\n  font-size: 24px;\n  color: #3F3F3F;\n}\n\n.wrapperForReserve {\n  display: flex;\n  align-items: center;\n}\n\n.requests__reserve {\n  display: flex;\n  align-items: center;\n  margin-right: 20px;\n}\n\n.requests__checkbox {\n  position: relative;\n  height: 20px;\n  width: 20px;\n  border-radius: 6px;\n  background-color: #E4E4E4;\n  cursor: pointer;\n  transition: 0.3s;\n}\n.requests__checkbox--active {\n  background-color: #FEED7E;\n}\n.requests__checkbox:hover {\n  background-color: #FEED7E;\n}\n\n.requests__checkmark {\n  display: none;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  width: 4px;\n  height: 8px;\n  border: solid black;\n  border-width: 1px 0 0 1px;\n  transform: translate(-50%, -50%) rotate(-135deg);\n}\n.requests__checkmark--active {\n  display: block;\n}\n\n.requests__text {\n  margin-left: 10px;\n  font-size: 14px;\n}\n\n.requests__filter {\n  position: relative;\n  display: inline-block;\n}\n.requests__filter-node {\n  color: #454545;\n  padding: 10px 10px;\n  text-decoration: none;\n  display: block;\n  font-size: 14px;\n}\n.requests__filter-node:hover {\n  background-color: #FEED7E;\n}\n.requests__filter-node--active {\n  background-color: #FEED7E;\n}\n\n.requests__filter-button {\n  display: flex;\n  width: 220px;\n  height: 32px;\n  border-radius: 6px;\n  background-color: #E4E4E4;\n  border-color: #E4E4E4;\n  cursor: pointer;\n}\n\n.requests__button-text {\n  color: #454545;\n  padding: 5px;\n  font-size: 14px;\n}\n\n.requests__button-arrow {\n  width: 8px;\n  height: 8px;\n  border: solid black;\n  border-width: 1px 0 0 1px;\n  transform: translate(-50%, -50%) rotate(-135deg);\n  position: absolute;\n  left: 90%;\n  top: 40%;\n  transition: 0.3s;\n}\n.requests__button-arrow--active {\n  top: 55%;\n  transform: translate(-50%, -50%) rotate(45deg);\n}\n\n.requests__filter-content {\n  display: none;\n  position: absolute;\n  background-color: #E4E4E4;\n  min-width: 218px;\n  overflow: auto;\n  border: 1px solid #ddd;\n  border-radius: 6px;\n  z-index: 1;\n}\n.requests__filter-content--active {\n  display: block;\n}\n\n.cardWrapper {\n  max-height: 100vh;\n}\n\n.bigCard {\n  position: fixed;\n  top: -130%;\n  left: 50%;\n  transform: translate(-50%, 0);\n  width: 460px;\n  transition: 0.5s;\n  z-index: 1;\n}\n.bigCard--active {\n  top: 30px;\n}\n\n.cardDescr {\n  background: #FFFFFF;\n  border-radius: 6px;\n  overflow: hidden;\n  width: 100%;\n  height: 100%;\n}\n.cardDescr--reserve {\n  background: #208085;\n}\n\n.cardDescr__imgBlock {\n  width: 100%;\n  height: 400px;\n}\n.cardDescr__imgBlock--reserve {\n  position: relative;\n}\n.cardDescr__imgBlock--reserve::before {\n  content: \"\";\n  position: absolute;\n  width: 100%;\n  height: 100%;\n  background: linear-gradient(180deg, #208085 0%, rgba(32, 128, 133, 0.0001) 100%);\n}\n.cardDescr__imgBlock img {\n  width: 100%;\n  height: 100%;\n}\n\n.cardDescr__reserveText {\n  font-size: 24px;\n  left: 5%;\n  top: 5%;\n}\n\n.cardDescr__bearsInfo {\n  padding: 20px 30px 30px 30px;\n  font-size: 13.2px;\n  max-height: 380px;\n  overflow-y: auto;\n  overflow-x: hidden;\n}\n\n.cardDescr__bearName {\n  color: #3F3F3F;\n  font-size: 24px;\n  margin-bottom: 7px;\n}\n.cardDescr__bearName--reserve {\n  font-size: 24px;\n  margin-bottom: 7px;\n  color: #FFFFFF;\n}\n\n.cardDescr__bearTypeNGender {\n  color: #767676;\n  font-size: 18px;\n}\n.cardDescr__bearTypeNGender--reserve {\n  color: #E7E7E7;\n  font-size: 18px;\n}\n\n.cardDescr__bearsInfo-descr {\n  margin-top: 16px;\n  color: #767676;\n}\n.cardDescr__bearsInfo-descr--reserve {\n  margin-top: 16px;\n  color: #E7E7E7;\n}\n\n.cardDescr__btns {\n  display: flex;\n  justify-content: space-around;\n}\n\n.cardClose {\n  position: absolute;\n  top: -0.5%;\n  left: 102%;\n  cursor: pointer;\n  width: 25px;\n  height: 25px;\n}\n.cardClose::before {\n  content: \"\";\n  position: fixed;\n  top: 1%;\n  left: 102%;\n  width: 25px;\n  height: 2px;\n  background: #FFFFFF;\n  transition: 0.5s;\n  transform: rotate(45deg);\n}\n.cardClose::after {\n  content: \"\";\n  position: fixed;\n  top: 1%;\n  left: 102%;\n  width: 25px;\n  height: 2px;\n  background: #FFFFFF;\n  transition: 0.5s;\n  transform: rotate(-45deg);\n}\n.cardClose:hover::before {\n  transform: rotate(-45deg);\n  background: indianred;\n}\n.cardClose:hover::after {\n  transform: rotate(-135deg);\n  background: indianred;\n}\n\nfooter {\n  width: 100%;\n  height: 40px;\n  background: #0E4447;\n  padding: 12px 290px;\n}\n\nfooter div {\n  font-size: 14px;\n  text-align: center;\n  color: #F4F4F4;\n}\n\n@media (max-width: 1199px) {\n  header {\n    padding-left: 30px;\n  }\n  .container {\n    padding: 20px 100px 0 100px;\n  }\n}\n@media (max-width: 991px) {\n  .wrapperForNavigation {\n    align-items: center;\n  }\n  .container {\n    padding: 20px 50px 0 50px;\n  }\n  .btn--accept {\n    width: 160px;\n    height: 28px;\n    font-size: 13px;\n  }\n  .btn--reject {\n    width: 160px;\n    height: 28px;\n    font-size: 13px;\n  }\n  .requests__promo {\n    font-size: 18px;\n  }\n  .requests__reserve {\n    margin-right: 20px;\n  }\n  .requests__text {\n    font-size: 13px;\n  }\n  .requests__cards {\n    margin-top: 25px;\n  }\n  .requests__bearName {\n    font-size: 16px;\n  }\n  .requests__bearTypeNGender {\n    font-size: 12px;\n  }\n  .requests__reserveText {\n    left: 20%;\n    font-size: 17px;\n  }\n  .requests__filter-button {\n    width: 190px;\n  }\n  .requests__button-text {\n    font-size: 13px;\n  }\n  .requests__filter-content {\n    min-width: 190px;\n  }\n  .requests__filter-node {\n    font-size: 13px;\n  }\n  .requests__cards-card {\n    height: 360px;\n    width: 200px;\n  }\n  .requests__cards-descr {\n    padding-top: 10px;\n  }\n  footer {\n    padding: 12px 230px;\n  }\n}\n@media (max-width: 767px) {\n  header {\n    padding-left: 5px;\n  }\n  .container {\n    padding: 20px 25px 0 25px;\n  }\n  .requests {\n    min-height: calc(100vh - 90px);\n  }\n  .requests__promo {\n    font-size: 16px;\n  }\n  .requests__reserve {\n    margin-right: 10px;\n  }\n  .requests__text {\n    font-size: 12px;\n  }\n  .requests__filter-button {\n    width: 160px;\n    height: 28px;\n  }\n  .requests__button-text {\n    font-size: 12px;\n    padding: 3px;\n  }\n  .requests__filter-content {\n    min-width: 160px;\n  }\n  .requests__filter-node {\n    font-size: 12px;\n  }\n  .requests__cards-card {\n    height: 380px;\n    width: 230px;\n  }\n  .requests__cards-imgBlock {\n    height: 190px;\n  }\n  footer {\n    padding: 8px 145px;\n    height: 30px;\n  }\n  footer div {\n    font-size: 12px;\n  }\n}\n@media (max-width: 575px) {\n  .hamburger {\n    display: block;\n  }\n  .hamburgerFilter {\n    display: flex;\n  }\n  .wrapperForReserve {\n    display: none;\n  }\n  .wrapperForNavigation {\n    display: block;\n    text-align: center;\n  }\n  .container {\n    padding: 15px 5px 0 5px;\n  }\n  .requests__promo {\n    position: relative;\n    font-size: 8vw;\n    background: linear-gradient(to left, #f69ec4, #f9dd94 100%);\n    background-position: 0 100%;\n    background-size: 100% 4px;\n    background-repeat: repeat-x;\n  }\n  .requests__cards {\n    width: 100%;\n    flex-direction: column;\n    align-items: center;\n  }\n  .requests__cards-card {\n    margin-right: 10px;\n  }\n  .requests__reserveText {\n    font-size: 20px;\n  }\n  .requests__bearName {\n    font-size: 25px;\n  }\n  .requests__bearTypeNGender {\n    font-size: 16px;\n  }\n  .requests__cards-btns {\n    margin-top: 20px;\n  }\n  .requests__cards-btns .btn--accept, .requests__cards-btns .btn--reject {\n    width: 180px;\n    height: 32px;\n    font-size: 15px;\n  }\n  .bigCard {\n    width: 80vw;\n  }\n  .cardDescr__imgBlock {\n    height: 40vh;\n  }\n  .cardDescr__bearsInfo {\n    max-height: 40vh;\n    padding: 5px 20px 5px 20px;\n    font-size: 11.2px;\n  }\n  .cardDescr__bearName {\n    font-size: 22px;\n  }\n  .cardDescr__bearTypeNGender {\n    font-size: 16px;\n  }\n  .cardDescr__btns {\n    padding-top: 10px;\n  }\n  .cardDescr__btns .btn--accept, .cardDescr__btns .btn--reject {\n    width: 40%;\n    height: 30px;\n    font-size: 13px;\n  }\n  footer {\n    padding: 9px 35px;\n  }\n  footer div {\n    font-size: 10px;\n  }\n}\n@media (max-width: 469px) {\n  .requests__cards-card {\n    margin-right: 0;\n  }\n}", "",{"version":3,"sources":["webpack://./src/scss/fonts.scss","webpack://./src/scss/main.scss","webpack://./src/scss/general.scss","webpack://./src/scss/mixins.scss","webpack://./src/scss/header.scss","webpack://./src/scss/requests.scss","webpack://./src/scss/requestsCards.scss","webpack://./src/scss/requestsFilter.scss","webpack://./src/scss/bigCard.scss","webpack://./src/scss/footer.scss","webpack://./src/scss/media.scss"],"names":[],"mappings":"AAAA;EACE,wBAAA;EACA,4CAAA;ACCF;ACHA;EACE,sBAAA;EACA,SAAA;EACA,wBAAA;EACA,kBAAA;ADKF;;ACFA;EACE,yBAAA;ADKF;;ACFA;EACE,WAAA;EACA,eAAA;EACA,WAAA;EACA,YAAA;EACA,wCAAA;UAAA,gCAAA;EACA,UAAA;ADKF;;ACFA;EACE,cAAA;ADKF;ACJE;EAAY,cAAA;ADOd;;ACJA;EACE,cAAA;ADOF;ACNE;EAAY,cAAA;ADSd;;ACNA;EACE,kBAAA;EACA,cAAA;ADSF;;ACNA;EClCE,YAAA;EACA,YAAA;EACA,mBAAA;EACA,YAAA;EACA,mBAAA;EACA,eAAA;EACA,gBAAA;EACA,eAAA;ED6BA,yBAAA;EACA,cAAA;ADgBF;ACfE;EACE,yBAAA;ADiBJ;;ACbA;EC3CE,YAAA;EACA,YAAA;EACA,mBAAA;EACA,YAAA;EACA,mBAAA;EACA,eAAA;EACA,gBAAA;EACA,eAAA;EDsCA,yBAAA;EACA,cAAA;ADuBF;ACtBE;EACE,yBAAA;ADwBJ;ACtBE;EACE,uBAAA;ADwBJ;;AG5EA;EACE,iBAAA;EACA,mBAAA;EACA,YAAA;EACA,yBAAA;AH+EF;AG9EE;EACE,qBAAA;AHgFJ;;AG5EA;EACE,aAAA;EACA,eAAA;EACA,SAAA;EACA,SAAA;AH+EF;AG9EE;EACE,cAAA;EACA,WAAA;EACA,WAAA;EACA,uBAAA;EACA,kBAAA;EACA,oBAAA;AHgFJ;AG7EI;EACE,yCAAA;AH+EN;AG7EI;EACE,aAAA;AH+EN;AG7EI;EACE,wCAAA;AH+EN;AG5EE;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,eAAA;EACA,YAAA;EACA,MAAA;EACA,kBAAA;EACA,YAAA;EACA,eAAA;EACA,oCAAA;EACA,wCAAA;EACA,UAAA;AH8EJ;AG7EI;EACE,iBAAA;AH+EN;AG5EI;EACE,kBAAA;EACA,SAAA;EACA,cAAA;EACA,iBAAA;EACA,aAAA;EACA,eAAA;AH8EN;AG3EI;EACE,kBAAA;EACA,mBAAA;AH6EN;AG5EM;EACE,WAAA;EACA,cAAA;EACA,kBAAA;EACA,SAAA;EACA,UAAA;EACA,UAAA;EACA,aAAA;EACA,uBAAA;AH8ER;AG1EI;EACE,cAAA;AH4EN;AG3EM;EACE,cAAA;AH6ER;AGzEI;EACE,cAAA;EACA,eAAA;EACA,eAAA;AH2EN;AG1EM;EACE,cAAA;AH4ER;;AGtEA;EACI,qBAAA;EACA,kBAAA;EACA,cAAA;EACA,iBAAA;EACA,eAAA;AHyEJ;;AI3KA;EACE,+BAAA;AJ8KF;;AI3KA;EACE,aAAA;EACA,eAAA;EACA,2BAAA;AJ8KF;;AKrLA;EACE,gBAAA;EACA,aAAA;EACA,eAAA;EACA,uBAAA;ALwLF;;AKrLA;EACE,aAAA;EACA,YAAA;EACA,kBAAA;EACA,mBAAA;EACA,yBAAA;EACA,8BAAA;EACA,qBAAA;EACA,eAAA;EACA,mBAAA;EACA,gBAAA;ALwLF;AKvLE;EACE,aAAA;ALyLJ;AKvLE;EACE,yBAAA;ALyLJ;AKvLE;EACE,mBAAA;ALyLJ;;AKrLA;EACE,kBAAA;EACA,aAAA;EACA,WAAA;EACA,gBAAA;EACA,0BAAA;ALwLF;AKvLE;EACE,YAAA;EACA,WAAA;ALyLJ;AKvLE;EACE,WAAA;EACA,kBAAA;EACA,WAAA;EACA,YAAA;EACA,gFAAA;ALyLJ;;AKpLA;EACE,kBAAA;EACA,iBAAA;ALuLF;;AKpLA;EACE,OAAA;EACA,SAAA;EACA,eAAA;ALuLF;;AKpLA;EACE,cHtCQ;EGuCR,eAAA;EACA,kBAAA;ALuLF;AKtLE;EACE,cHzCa;EG0Cb,kBAAA;ALwLJ;;AKpLA;EACE,cH9CQ;EG+CR,eAAA;ALuLF;AKtLE;EACE,cHhDa;AFwOjB;;AKpLA;EACE,aAAA;EACA,uBAAA;EACA,eAAA;EACA,gBAAA;ALuLF;;AMzQA;EACE,aAAA;EACA,8BAAA;EACA,WAAA;AN4QF;;AMzQA;EACE,eAAA;EACA,cAAA;AN4QF;;AMzQA;EACE,aAAA;EACA,mBAAA;AN4QF;;AMzQA;EACE,aAAA;EACA,mBAAA;EACA,kBAAA;AN4QF;;AMzQA;EACE,kBAAA;EACA,YAAA;EACA,WAAA;EACA,kBAAA;EACA,yBAAA;EACA,eAAA;EACA,gBAAA;AN4QF;AM3QE;EACE,yBAAA;AN6QJ;AM3QE;EACE,yBAAA;AN6QJ;;AMzQA;EACE,aAAA;EACA,kBAAA;EACA,QAAA;EACA,SAAA;EACA,UAAA;EACA,WAAA;EACA,mBAAA;EACA,yBAAA;EACA,gDAAA;AN4QF;AM3QE;EACE,cAAA;AN6QJ;;AMzQA;EACE,iBAAA;EACA,eAAA;AN4QF;;AMzQA;EACE,kBAAA;EACA,qBAAA;AN4QF;AM3QE;EACE,cAAA;EACA,kBAAA;EACA,qBAAA;EACA,cAAA;EACA,eAAA;AN6QJ;AM5QI;EACE,yBAAA;AN8QN;AM5QI;EACE,yBAAA;AN8QN;;AMzQA;EACE,aAAA;EACA,YAAA;EACA,YAAA;EACA,kBAAA;EACA,yBAAA;EACA,qBAAA;EACA,eAAA;AN4QF;;AMzQA;EACE,cAAA;EACA,YAAA;EACA,eAAA;AN4QF;;AMzQA;EACE,UAAA;EACA,WAAA;EACA,mBAAA;EACA,yBAAA;EACA,gDAAA;EACA,kBAAA;EACA,SAAA;EACA,QAAA;EACA,gBAAA;AN4QF;AM3QE;EACE,QAAA;EACA,8CAAA;AN6QJ;;AMzQA;EACE,aAAA;EACA,kBAAA;EACA,yBAAA;EACA,gBAAA;EACA,cAAA;EACA,sBAAA;EACA,kBAAA;EACA,UAAA;AN4QF;AM3QE;EACE,cAAA;AN6QJ;;AOnYA;EACE,iBAAA;APsYF;;AOnYA;EACE,eAAA;EACA,UAAA;EACA,SAAA;EACA,6BAAA;EACA,YAAA;EACA,gBAAA;EACA,UAAA;APsYF;AOrYE;EACE,SAAA;APuYJ;;AOnYA;EACE,mBAAA;EACA,kBAAA;EACA,gBAAA;EACA,WAAA;EACA,YAAA;APsYF;AOrYE;EACE,mBAAA;APuYJ;;AOnYA;EACE,WAAA;EACA,aAAA;APsYF;AOrYE;EACE,kBAAA;APuYJ;AOtYI;EACE,WAAA;EACA,kBAAA;EACA,WAAA;EACA,YAAA;EACA,gFAAA;APwYN;AOrYE;EACE,WAAA;EACA,YAAA;APuYJ;;AOnYA;EACE,eAAA;EACA,QAAA;EACA,OAAA;APsYF;;AOnYA;EACE,4BAAA;EACA,iBAAA;EACA,iBAAA;EACA,gBAAA;EACA,kBAAA;APsYF;;AOnYA;EACE,cLvCQ;EKwCR,eAAA;EACA,kBAAA;APsYF;AOrYE;EACE,eAAA;EACA,kBAAA;EACA,cL5Ca;AFmbjB;;AOnYA;EACE,cLhDQ;EKiDR,eAAA;APsYF;AOrYE;EACE,cLlDa;EKmDb,eAAA;APuYJ;;AOnYA;EACE,gBAAA;EACA,cL1DQ;AFgcV;AOrYE;EACE,gBAAA;EACA,cL5Da;AFmcjB;;AOnYA;EACE,aAAA;EACA,6BAAA;APsYF;;AOnYA;EACE,kBAAA;EACA,UAAA;EACA,UAAA;EACA,eAAA;EACA,WAAA;EACA,YAAA;APsYF;AOrYE;EL1FA,WAAA;EACA,eAAA;EACA,OAAA;EACA,UAAA;EACA,WAAA;EACA,WAAA;EACA,mBAAA;EACA,gBAAA;EKqFE,wBAAA;AP8YJ;AO5YE;EL9FA,WAAA;EACA,eAAA;EACA,OAAA;EACA,UAAA;EACA,WAAA;EACA,WAAA;EACA,mBAAA;EACA,gBAAA;EKyFE,yBAAA;APqZJ;AOnZE;EACE,yBAAA;EACA,qBAAA;APqZJ;AOnZE;EACE,0BAAA;EACA,qBAAA;APqZJ;;AQzgBA;EACE,WAAA;EACA,YAAA;EACA,mBAAA;EACA,mBAAA;AR4gBF;;AQzgBA;EACE,eAAA;EACA,kBAAA;EACA,cAAA;AR4gBF;;ASthBA;EACE;IACE,kBAAA;ETyhBF;ESvhBA;IACE,2BAAA;ETyhBF;AACF;ASthBA;EACE;IACE,mBAAA;ETwhBF;ESrhBA;IACE,yBAAA;ETuhBF;ESphBA;IACE,YAAA;IACA,YAAA;IACA,eAAA;ETshBF;ESnhBA;IACE,YAAA;IACA,YAAA;IACA,eAAA;ETqhBF;ESjhBE;IACE,eAAA;ETmhBJ;ESjhBE;IACE,kBAAA;ETmhBJ;ESjhBE;IACE,eAAA;ETmhBJ;ESjhBE;IACE,gBAAA;ETmhBJ;ESjhBE;IACE,eAAA;ETmhBJ;ESjhBE;IACE,eAAA;ETmhBJ;ESjhBE;IACE,SAAA;IACA,eAAA;ETmhBJ;ESjhBE;IACE,YAAA;ETmhBJ;ESjhBE;IACE,eAAA;ETmhBJ;ESjhBE;IACE,gBAAA;ETmhBJ;ESjhBE;IACE,eAAA;ETmhBJ;ESjhBE;IACE,aAAA;IACA,YAAA;ETmhBJ;ESjhBE;IACE,iBAAA;ETmhBJ;ES/gBA;IACE,mBAAA;ETihBF;AACF;AS9gBA;EACE;IACE,iBAAA;ETghBF;ES7gBA;IACE,yBAAA;ET+gBF;ES5gBA;IACE,8BAAA;ET8gBF;ES7gBE;IACE,eAAA;ET+gBJ;ES7gBE;IACE,kBAAA;ET+gBJ;ES7gBE;IACE,eAAA;ET+gBJ;ES7gBE;IACE,YAAA;IACA,YAAA;ET+gBJ;ES7gBE;IACE,eAAA;IACA,YAAA;ET+gBJ;ES7gBE;IACE,gBAAA;ET+gBJ;ES7gBE;IACE,eAAA;ET+gBJ;ES7gBE;IACE,aAAA;IACA,YAAA;ET+gBJ;ES7gBE;IACE,aAAA;ET+gBJ;ES3gBA;IACE,kBAAA;IACA,YAAA;ET6gBF;ES5gBE;IACE,eAAA;ET8gBJ;AACF;AS1gBA;EAEE;IACE,cAAA;ET2gBF;ESxgBA;IACE,aAAA;ET0gBF;ESvgBA;IACE,aAAA;ETygBF;EStgBA;IACE,cAAA;IACA,kBAAA;ETwgBF;ESrgBA;IACE,uBAAA;ETugBF;ESngBE;IACE,kBAAA;IACA,cAAA;IACA,2DAAA;IACA,2BAAA;IACA,yBAAA;IACA,2BAAA;ETqgBJ;ESngBE;IACE,WAAA;IACA,sBAAA;IACA,mBAAA;ETqgBJ;ESngBE;IACE,kBAAA;ETqgBJ;ESngBE;IACE,eAAA;ETqgBJ;ESngBE;IACE,eAAA;ETqgBJ;ESngBE;IACE,eAAA;ETqgBJ;ESngBE;IACE,gBAAA;ETqgBJ;ESpgBI;IACE,YAAA;IACA,YAAA;IACA,eAAA;ETsgBN;ESjgBA;IACE,WAAA;ETmgBF;EShgBA;IACE,YAAA;ETkgBF;ES/fA;IACE,gBAAA;IACA,0BAAA;IACA,iBAAA;ETigBF;ES9fA;IACE,eAAA;ETggBF;ES7fA;IACE,eAAA;ET+fF;ES5fA;IACE,iBAAA;ET8fF;ES7fE;IACE,UAAA;IACA,YAAA;IACA,eAAA;ET+fJ;ES3fA;IACE,iBAAA;ET6fF;ES5fE;IACE,eAAA;ET8fJ;AACF;ASzfA;EACE;IACE,eAAA;ET2fF;AACF","sourcesContent":["@font-face {\n  font-family: generalFont;\n  src: url(\"../fonts/Raleway/static/Raleway-Regular.ttf\")\n}","@font-face {\n  font-family: generalFont;\n  src: url(\"../fonts/Raleway/static/Raleway-Regular.ttf\");\n}\n* {\n  box-sizing: border-box;\n  margin: 0;\n  font-family: generalFont;\n  font-style: normal;\n}\n\nbody {\n  background-color: #F2F2F2;\n}\n\n.blur:before {\n  content: \"\";\n  position: fixed;\n  width: 100%;\n  height: 100%;\n  backdrop-filter: blur(40.7742px);\n  z-index: 1;\n}\n\n.bearName {\n  color: #3F3F3F;\n}\n.bearName--reserve {\n  color: #FFFFFF;\n}\n\n.bearTypeNGender {\n  color: #767676;\n}\n.bearTypeNGender--reserve {\n  color: #E7E7E7;\n}\n\n.reserveText {\n  position: absolute;\n  color: #58FFB5;\n}\n\n.btn--accept {\n  width: 180px;\n  height: 32px;\n  margin-bottom: 10px;\n  border: 16px;\n  border-radius: 16px;\n  font-size: 14px;\n  transition: 0.3s;\n  cursor: pointer;\n  background-color: #58FFB5;\n  color: #208085;\n}\n.btn--accept:hover {\n  background-color: #FEED7E;\n}\n\n.btn--reject {\n  width: 180px;\n  height: 32px;\n  margin-bottom: 10px;\n  border: 16px;\n  border-radius: 16px;\n  font-size: 14px;\n  transition: 0.3s;\n  cursor: pointer;\n  background-color: #208085;\n  color: #FFFFFF;\n}\n.btn--reject:hover {\n  background-color: #0E4447;\n}\n.btn--reject--reserve {\n  border: 2px solid white;\n}\n\nheader {\n  padding-top: 13px;\n  padding-left: 130px;\n  height: 60px;\n  background-color: #0E4447;\n}\nheader img {\n  display: inline-block;\n}\n\n.hamburger {\n  display: none;\n  position: fixed;\n  top: 20px;\n  left: 90%;\n}\n.hamburger span {\n  display: block;\n  height: 2px;\n  width: 20px;\n  background-color: black;\n  margin-bottom: 2px;\n  transition: 0.5s all;\n}\n.hamburger--active span:nth-child(1) {\n  transform: translateY(7px) rotate(-45deg);\n}\n.hamburger--active span:nth-child(2) {\n  display: none;\n}\n.hamburger--active span:nth-child(3) {\n  transform: translateY(3px) rotate(45deg);\n}\n.hamburgerFilter {\n  display: none;\n  flex-direction: column;\n  align-items: center;\n  position: fixed;\n  width: 240px;\n  top: 0;\n  margin-left: -100%;\n  height: 101%;\n  font-size: 16px;\n  background-color: rgba(0, 0, 0, 0.9);\n  transition: visibility, margin-left 0.5s;\n  z-index: 2;\n}\n.hamburgerFilter--active {\n  margin-left: -5px;\n}\n.hamburgerFilter__main {\n  position: absolute;\n  top: 10px;\n  color: #FEED7E;\n  border: 2px solid;\n  padding: 0 7%;\n  font-size: 20px;\n}\n.hamburgerFilter--accepted {\n  position: relative;\n  margin: 50% 0 30% 0;\n}\n.hamburgerFilter--accepted::before {\n  content: \"\";\n  display: block;\n  position: absolute;\n  top: -5px;\n  left: -10%;\n  width: 2px;\n  height: 100px;\n  background-color: white;\n}\n.hamburgerFilter__node {\n  color: #E7E7E7;\n}\n.hamburgerFilter__node--active {\n  color: #FEED7E;\n}\n.hamburgerFilter__reserve {\n  color: #E7E7E7;\n  margin-top: 40%;\n  font-size: 18px;\n}\n.hamburgerFilter__reserve--active {\n  color: #FEED7E;\n}\n\n.header__text {\n  display: inline-block;\n  position: absolute;\n  color: #F4F4F4;\n  margin-left: 12px;\n  font-size: 24px;\n}\n\n.requests {\n  min-height: calc(100vh - 100px);\n}\n\n.container {\n  display: flex;\n  flex-wrap: wrap;\n  padding: 42px 240px 0 240px;\n}\n\n.requests__cards {\n  margin-top: 39px;\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: center;\n}\n\n.requests__cards-card {\n  height: 380px;\n  width: 220px;\n  margin-right: 20px;\n  margin-bottom: 20px;\n  background-color: #FFFFFF;\n  border-radius: 6px 6px 6px 6px;\n  text-decoration: none;\n  CURSOR: pointer;\n  border-color: white;\n  transition: 0.5s;\n}\n.requests__cards-card--inactive {\n  display: none;\n}\n.requests__cards-card:hover {\n  border: 1px solid #208085;\n}\n.requests__cards-card--reserve {\n  background: #208085;\n}\n\n.requests__cards-imgBlock {\n  position: relative;\n  height: 180px;\n  width: 100%;\n  overflow: hidden;\n  border-radius: 6px 6px 0 0;\n}\n.requests__cards-imgBlock img {\n  height: 100%;\n  width: 100%;\n}\n.requests__cards-imgBlock--reserve::before {\n  content: \"\";\n  position: absolute;\n  width: 100%;\n  height: 100%;\n  background: linear-gradient(180deg, #208085 0%, rgba(32, 128, 133, 0.0001) 100%);\n}\n\n.requests__cards-descr {\n  text-align: center;\n  padding-top: 20px;\n}\n\n.requests__reserveText {\n  top: 8%;\n  left: 25%;\n  font-size: 18px;\n}\n\n.requests__bearName {\n  color: #3F3F3F;\n  font-size: 18px;\n  margin-bottom: 9px;\n}\n.requests__bearName--reserve {\n  color: #FFFFFF;\n  margin-bottom: 9px;\n}\n\n.requests__bearTypeNGender {\n  color: #767676;\n  font-size: 14px;\n}\n.requests__bearTypeNGender--reserve {\n  color: #E7E7E7;\n}\n\n.requests__cards-btns {\n  display: flex;\n  justify-content: center;\n  flex-wrap: wrap;\n  margin-top: 24px;\n}\n\n.wrapperForNavigation {\n  display: flex;\n  justify-content: space-between;\n  width: 100%;\n}\n\n.requests__promo {\n  font-size: 24px;\n  color: #3F3F3F;\n}\n\n.wrapperForReserve {\n  display: flex;\n  align-items: center;\n}\n\n.requests__reserve {\n  display: flex;\n  align-items: center;\n  margin-right: 20px;\n}\n\n.requests__checkbox {\n  position: relative;\n  height: 20px;\n  width: 20px;\n  border-radius: 6px;\n  background-color: #E4E4E4;\n  cursor: pointer;\n  transition: 0.3s;\n}\n.requests__checkbox--active {\n  background-color: #FEED7E;\n}\n.requests__checkbox:hover {\n  background-color: #FEED7E;\n}\n\n.requests__checkmark {\n  display: none;\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  width: 4px;\n  height: 8px;\n  border: solid black;\n  border-width: 1px 0 0 1px;\n  transform: translate(-50%, -50%) rotate(-135deg);\n}\n.requests__checkmark--active {\n  display: block;\n}\n\n.requests__text {\n  margin-left: 10px;\n  font-size: 14px;\n}\n\n.requests__filter {\n  position: relative;\n  display: inline-block;\n}\n.requests__filter-node {\n  color: #454545;\n  padding: 10px 10px;\n  text-decoration: none;\n  display: block;\n  font-size: 14px;\n}\n.requests__filter-node:hover {\n  background-color: #FEED7E;\n}\n.requests__filter-node--active {\n  background-color: #FEED7E;\n}\n\n.requests__filter-button {\n  display: flex;\n  width: 220px;\n  height: 32px;\n  border-radius: 6px;\n  background-color: #E4E4E4;\n  border-color: #E4E4E4;\n  cursor: pointer;\n}\n\n.requests__button-text {\n  color: #454545;\n  padding: 5px;\n  font-size: 14px;\n}\n\n.requests__button-arrow {\n  width: 8px;\n  height: 8px;\n  border: solid black;\n  border-width: 1px 0 0 1px;\n  transform: translate(-50%, -50%) rotate(-135deg);\n  position: absolute;\n  left: 90%;\n  top: 40%;\n  transition: 0.3s;\n}\n.requests__button-arrow--active {\n  top: 55%;\n  transform: translate(-50%, -50%) rotate(45deg);\n}\n\n.requests__filter-content {\n  display: none;\n  position: absolute;\n  background-color: #E4E4E4;\n  min-width: 218px;\n  overflow: auto;\n  border: 1px solid #ddd;\n  border-radius: 6px;\n  z-index: 1;\n}\n.requests__filter-content--active {\n  display: block;\n}\n\n.cardWrapper {\n  max-height: 100vh;\n}\n\n.bigCard {\n  position: fixed;\n  top: -130%;\n  left: 50%;\n  transform: translate(-50%, 0);\n  width: 460px;\n  transition: 0.5s;\n  z-index: 1;\n}\n.bigCard--active {\n  top: 30px;\n}\n\n.cardDescr {\n  background: #FFFFFF;\n  border-radius: 6px;\n  overflow: hidden;\n  width: 100%;\n  height: 100%;\n}\n.cardDescr--reserve {\n  background: #208085;\n}\n\n.cardDescr__imgBlock {\n  width: 100%;\n  height: 400px;\n}\n.cardDescr__imgBlock--reserve {\n  position: relative;\n}\n.cardDescr__imgBlock--reserve::before {\n  content: \"\";\n  position: absolute;\n  width: 100%;\n  height: 100%;\n  background: linear-gradient(180deg, #208085 0%, rgba(32, 128, 133, 0.0001) 100%);\n}\n.cardDescr__imgBlock img {\n  width: 100%;\n  height: 100%;\n}\n\n.cardDescr__reserveText {\n  font-size: 24px;\n  left: 5%;\n  top: 5%;\n}\n\n.cardDescr__bearsInfo {\n  padding: 20px 30px 30px 30px;\n  font-size: 13.2px;\n  max-height: 380px;\n  overflow-y: auto;\n  overflow-x: hidden;\n}\n\n.cardDescr__bearName {\n  color: #3F3F3F;\n  font-size: 24px;\n  margin-bottom: 7px;\n}\n.cardDescr__bearName--reserve {\n  font-size: 24px;\n  margin-bottom: 7px;\n  color: #FFFFFF;\n}\n\n.cardDescr__bearTypeNGender {\n  color: #767676;\n  font-size: 18px;\n}\n.cardDescr__bearTypeNGender--reserve {\n  color: #E7E7E7;\n  font-size: 18px;\n}\n\n.cardDescr__bearsInfo-descr {\n  margin-top: 16px;\n  color: #767676;\n}\n.cardDescr__bearsInfo-descr--reserve {\n  margin-top: 16px;\n  color: #E7E7E7;\n}\n\n.cardDescr__btns {\n  display: flex;\n  justify-content: space-around;\n}\n\n.cardClose {\n  position: absolute;\n  top: -0.5%;\n  left: 102%;\n  cursor: pointer;\n  width: 25px;\n  height: 25px;\n}\n.cardClose::before {\n  content: \"\";\n  position: fixed;\n  top: 1%;\n  left: 102%;\n  width: 25px;\n  height: 2px;\n  background: #FFFFFF;\n  transition: 0.5s;\n  transform: rotate(45deg);\n}\n.cardClose::after {\n  content: \"\";\n  position: fixed;\n  top: 1%;\n  left: 102%;\n  width: 25px;\n  height: 2px;\n  background: #FFFFFF;\n  transition: 0.5s;\n  transform: rotate(-45deg);\n}\n.cardClose:hover::before {\n  transform: rotate(-45deg);\n  background: indianred;\n}\n.cardClose:hover::after {\n  transform: rotate(-135deg);\n  background: indianred;\n}\n\nfooter {\n  width: 100%;\n  height: 40px;\n  background: #0E4447;\n  padding: 12px 290px;\n}\n\nfooter div {\n  font-size: 14px;\n  text-align: center;\n  color: #F4F4F4;\n}\n\n@media (max-width: 1199px) {\n  header {\n    padding-left: 30px;\n  }\n  .container {\n    padding: 20px 100px 0 100px;\n  }\n}\n@media (max-width: 991px) {\n  .wrapperForNavigation {\n    align-items: center;\n  }\n  .container {\n    padding: 20px 50px 0 50px;\n  }\n  .btn--accept {\n    width: 160px;\n    height: 28px;\n    font-size: 13px;\n  }\n  .btn--reject {\n    width: 160px;\n    height: 28px;\n    font-size: 13px;\n  }\n  .requests__promo {\n    font-size: 18px;\n  }\n  .requests__reserve {\n    margin-right: 20px;\n  }\n  .requests__text {\n    font-size: 13px;\n  }\n  .requests__cards {\n    margin-top: 25px;\n  }\n  .requests__bearName {\n    font-size: 16px;\n  }\n  .requests__bearTypeNGender {\n    font-size: 12px;\n  }\n  .requests__reserveText {\n    left: 20%;\n    font-size: 17px;\n  }\n  .requests__filter-button {\n    width: 190px;\n  }\n  .requests__button-text {\n    font-size: 13px;\n  }\n  .requests__filter-content {\n    min-width: 190px;\n  }\n  .requests__filter-node {\n    font-size: 13px;\n  }\n  .requests__cards-card {\n    height: 360px;\n    width: 200px;\n  }\n  .requests__cards-descr {\n    padding-top: 10px;\n  }\n  footer {\n    padding: 12px 230px;\n  }\n}\n@media (max-width: 767px) {\n  header {\n    padding-left: 5px;\n  }\n  .container {\n    padding: 20px 25px 0 25px;\n  }\n  .requests {\n    min-height: calc(100vh - 90px);\n  }\n  .requests__promo {\n    font-size: 16px;\n  }\n  .requests__reserve {\n    margin-right: 10px;\n  }\n  .requests__text {\n    font-size: 12px;\n  }\n  .requests__filter-button {\n    width: 160px;\n    height: 28px;\n  }\n  .requests__button-text {\n    font-size: 12px;\n    padding: 3px;\n  }\n  .requests__filter-content {\n    min-width: 160px;\n  }\n  .requests__filter-node {\n    font-size: 12px;\n  }\n  .requests__cards-card {\n    height: 380px;\n    width: 230px;\n  }\n  .requests__cards-imgBlock {\n    height: 190px;\n  }\n  footer {\n    padding: 8px 145px;\n    height: 30px;\n  }\n  footer div {\n    font-size: 12px;\n  }\n}\n@media (max-width: 575px) {\n  .hamburger {\n    display: block;\n  }\n  .hamburgerFilter {\n    display: flex;\n  }\n  .wrapperForReserve {\n    display: none;\n  }\n  .wrapperForNavigation {\n    display: block;\n    text-align: center;\n  }\n  .container {\n    padding: 15px 5px 0 5px;\n  }\n  .requests__promo {\n    position: relative;\n    font-size: 8vw;\n    background: linear-gradient(to left, #f69ec4, #f9dd94 100%);\n    background-position: 0 100%;\n    background-size: 100% 4px;\n    background-repeat: repeat-x;\n  }\n  .requests__cards {\n    width: 100%;\n    flex-direction: column;\n    align-items: center;\n  }\n  .requests__cards-card {\n    margin-right: 10px;\n  }\n  .requests__reserveText {\n    font-size: 20px;\n  }\n  .requests__bearName {\n    font-size: 25px;\n  }\n  .requests__bearTypeNGender {\n    font-size: 16px;\n  }\n  .requests__cards-btns {\n    margin-top: 20px;\n  }\n  .requests__cards-btns .btn--accept, .requests__cards-btns .btn--reject {\n    width: 180px;\n    height: 32px;\n    font-size: 15px;\n  }\n  .bigCard {\n    width: 80vw;\n  }\n  .cardDescr__imgBlock {\n    height: 40vh;\n  }\n  .cardDescr__bearsInfo {\n    max-height: 40vh;\n    padding: 5px 20px 5px 20px;\n    font-size: 11.2px;\n  }\n  .cardDescr__bearName {\n    font-size: 22px;\n  }\n  .cardDescr__bearTypeNGender {\n    font-size: 16px;\n  }\n  .cardDescr__btns {\n    padding-top: 10px;\n  }\n  .cardDescr__btns .btn--accept, .cardDescr__btns .btn--reject {\n    width: 40%;\n    height: 30px;\n    font-size: 13px;\n  }\n  footer {\n    padding: 9px 35px;\n  }\n  footer div {\n    font-size: 10px;\n  }\n}\n@media (max-width: 469px) {\n  .requests__cards-card {\n    margin-right: 0;\n  }\n}","* {\r\n  box-sizing: border-box;\r\n  margin: 0;\r\n  font-family: generalFont;\r\n  font-style: normal;\r\n}\r\n\r\nbody {\r\n  background-color: #F2F2F2;\r\n}\r\n\r\n.blur:before{\r\n  content: '';\r\n  position: fixed;\r\n  width: 100%;\r\n  height: 100%;\r\n  backdrop-filter: blur(40.7742px);\r\n  z-index: 1;\r\n}\r\n\r\n.bearName{\r\n  color: #3F3F3F;\r\n  &--reserve {color: #FFFFFF}\r\n}\r\n\r\n.bearTypeNGender {\r\n  color: #767676;\r\n  &--reserve {color: #E7E7E7;}\r\n}\r\n\r\n.reserveText {\r\n  position: absolute;\r\n  color: #58FFB5;\r\n}\r\n\r\n.btn--accept {\r\n  @include button;\r\n  background-color: #58FFB5;\r\n  color: #208085;\r\n  &:hover {\r\n    background-color: #FEED7E;\r\n  }\r\n}\r\n\r\n.btn--reject {\r\n  @include button;\r\n  background-color: #208085;\r\n  color: #FFFFFF;\r\n  &:hover{\r\n    background-color: #0E4447;\r\n  }\r\n  &--reserve {\r\n    border: 2px solid white;\r\n  }\r\n}","@mixin button {\r\n  width: 180px;\r\n  height: 32px;\r\n  margin-bottom: 10px;\r\n  border: 16px;\r\n  border-radius: 16px;\r\n  font-size: 14px;\r\n  transition: 0.3s;\r\n  cursor: pointer;\r\n}\r\n\r\n@mixin cross {\r\n  content: \"\";\r\n  position: fixed;\r\n  top: 1%;\r\n  left: 102%;\r\n  width: 25px;\r\n  height: 2px;\r\n  background: #FFFFFF;\r\n  transition: 0.5s\r\n}\r\n\r\n$colorRed: red;\r\n$color3F: #3F3F3F;\r\n$colorReserveFF: #FFFFFF;\r\n$color76: #767676;\r\n$colorReserveE7: #E7E7E7;","header {\r\n  padding-top: 13px;\r\n  padding-left: 130px;\r\n  height: 60px;\r\n  background-color: #0E4447;\r\n  img {\r\n    display: inline-block\r\n  }\r\n}\r\n\r\n.hamburger {\r\n  display: none;\r\n  position: fixed;\r\n  top: 20px;\r\n  left: 90%;\r\n  span {\r\n    display: block;\r\n    height: 2px;\r\n    width: 20px;\r\n    background-color: black;\r\n    margin-bottom: 2px;\r\n    transition: 0.5s all;\r\n  }\r\n  &--active {\r\n    span:nth-child(1) {\r\n      transform: translateY(7px) rotate(-45deg);\r\n    }\r\n    span:nth-child(2) {\r\n      display: none\r\n    }\r\n    span:nth-child(3) {\r\n      transform: translateY(3px) rotate(45deg);\r\n    }\r\n  }\r\n  &Filter {\r\n    display: none;\r\n    flex-direction: column;\r\n    align-items: center;\r\n    position: fixed;\r\n    width: 240px;\r\n    top: 0;\r\n    margin-left: -100%;\r\n    height: 101%;\r\n    font-size: 16px;\r\n    background-color: rgba(0, 0, 0, 0.9);\r\n    transition: visibility, margin-left 0.5s;\r\n    z-index: 2;\r\n    &--active {\r\n      margin-left: -5px;\r\n    }\r\n\r\n    &__main{\r\n      position: absolute;\r\n      top: 10px;\r\n      color: #FEED7E;\r\n      border: 2px solid;\r\n      padding: 0 7%;\r\n      font-size: 20px;\r\n    }\r\n\r\n    &--accepted {\r\n      position: relative;\r\n      margin: 50% 0 30% 0;\r\n      &::before {\r\n        content: '';\r\n        display: block;\r\n        position: absolute;\r\n        top: -5px;\r\n        left: -10%;\r\n        width: 2px;\r\n        height: 100px;\r\n        background-color: white;\r\n      }\r\n    }\r\n\r\n    &__node {\r\n      color: #E7E7E7;\r\n      &--active {\r\n        color: #FEED7E;\r\n      }\r\n    }\r\n\r\n    &__reserve {\r\n      color: #E7E7E7;\r\n      margin-top: 40%;\r\n      font-size: 18px;\r\n      &--active{\r\n        color: #FEED7E;\r\n      }\r\n    }\r\n  }\r\n}\r\n\r\n.header__text {\r\n    display: inline-block;\r\n    position: absolute;\r\n    color: #F4F4F4;\r\n    margin-left: 12px;\r\n    font-size: 24px;\r\n  }\r\n",".requests {\r\n  min-height: calc(100vh - 100px);\r\n}\r\n\r\n.container {\r\n  display: flex;\r\n  flex-wrap: wrap;\r\n  padding: 42px 240px 0 240px;\r\n}\r\n\r\n",".requests__cards {\r\n  margin-top: 39px;\r\n  display: flex;\r\n  flex-wrap: wrap;\r\n  justify-content: center;\r\n}\r\n\r\n.requests__cards-card{\r\n  height: 380px;\r\n  width: 220px;\r\n  margin-right: 20px;\r\n  margin-bottom: 20px;\r\n  background-color: #FFFFFF;\r\n  border-radius: 6px 6px 6px 6px;\r\n  text-decoration: none;\r\n  CURSOR: pointer;\r\n  border-color: white;\r\n  transition: 0.5s;\r\n  &--inactive{\r\n    display:none\r\n  }\r\n  &:hover{\r\n    border: 1px solid #208085;\r\n  }\r\n  &--reserve {\r\n    background: #208085;\r\n  }\r\n}\r\n\r\n.requests__cards-imgBlock{\r\n  position: relative;\r\n  height: 180px;\r\n  width: 100%;\r\n  overflow: hidden;\r\n  border-radius: 6px 6px 0 0;\r\n  img {\r\n    height: 100%;\r\n    width: 100%\r\n  }\r\n  &--reserve::before{\r\n    content: \"\";\r\n    position: absolute;\r\n    width: 100%;\r\n    height: 100%;\r\n    background: linear-gradient(180deg, #208085 0%, rgba(32, 128, 133, 0.0001) 100%);\r\n  }\r\n\r\n}\r\n\r\n.requests__cards-descr{\r\n  text-align: center;\r\n  padding-top: 20px\r\n}\r\n\r\n.requests__reserveText{\r\n  top: 8%;\r\n  left: 25%;\r\n  font-size: 18px;\r\n}\r\n\r\n.requests__bearName{\r\n  color: $color3F;\r\n  font-size: 18px;\r\n  margin-bottom: 9px;\r\n  &--reserve{\r\n    color: $colorReserveFF;\r\n    margin-bottom: 9px;\r\n  }\r\n}\r\n\r\n.requests__bearTypeNGender {\r\n  color: $color76;\r\n  font-size: 14px;\r\n  &--reserve{\r\n    color: $colorReserveE7;\r\n  }\r\n}\r\n\r\n.requests__cards-btns{\r\n  display: flex;\r\n  justify-content: center;\r\n  flex-wrap: wrap;\r\n  margin-top: 24px;\r\n}",".wrapperForNavigation {\r\n  display: flex;\r\n  justify-content: space-between;\r\n  width: 100%;\r\n}\r\n\r\n.requests__promo {\r\n  font-size: 24px;\r\n  color: #3F3F3F;\r\n}\r\n\r\n.wrapperForReserve {\r\n  display: flex;\r\n  align-items: center;\r\n}\r\n\r\n.requests__reserve {\r\n  display: flex;\r\n  align-items: center;\r\n  margin-right: 20px;\r\n}\r\n\r\n.requests__checkbox {\r\n  position: relative;\r\n  height: 20px;\r\n  width: 20px;\r\n  border-radius: 6px;\r\n  background-color: #E4E4E4;\r\n  cursor: pointer;\r\n  transition: 0.3s;\r\n  &--active {\r\n    background-color: #FEED7E;\r\n  }\r\n  &:hover {\r\n    background-color: #FEED7E;\r\n  }\r\n}\r\n\r\n.requests__checkmark {\r\n  display: none;\r\n  position: absolute;\r\n  top: 50%;\r\n  left: 50%;\r\n  width: 4px;\r\n  height: 8px;\r\n  border:  solid black;\r\n  border-width: 1px 0 0 1px;\r\n  transform: translate(-50%, -50%) rotate(-135deg);\r\n  &--active {\r\n    display: block;\r\n  }\r\n}\r\n\r\n.requests__text {\r\n  margin-left: 10px;\r\n  font-size: 14px;\r\n}\r\n\r\n.requests__filter {\r\n  position: relative;\r\n  display: inline-block;\r\n  &-node {\r\n    color: #454545;\r\n    padding: 10px 10px;\r\n    text-decoration: none;\r\n    display: block;\r\n    font-size: 14px;\r\n    &:hover{\r\n      background-color: #FEED7E;\r\n    }\r\n    &--active {\r\n      background-color: #FEED7E\r\n    }\r\n  }\r\n}\r\n\r\n.requests__filter-button{\r\n  display: flex;\r\n  width: 220px;\r\n  height: 32px;\r\n  border-radius: 6px;\r\n  background-color: #E4E4E4;\r\n  border-color: #E4E4E4;\r\n  cursor: pointer;\r\n}\r\n\r\n.requests__button-text {\r\n  color: #454545;\r\n  padding: 5px;\r\n  font-size: 14px;\r\n}\r\n\r\n.requests__button-arrow {\r\n  width: 8px;\r\n  height: 8px;\r\n  border:  solid black;\r\n  border-width: 1px 0 0 1px;\r\n  transform: translate(-50%, -50%) rotate(-135deg);\r\n  position: absolute;\r\n  left: 90%;\r\n  top: 40%;\r\n  transition: 0.3s;\r\n  &--active {\r\n    top: 55%;\r\n    transform: translate(-50%, -50%) rotate(45deg);\r\n  }\r\n}\r\n\r\n.requests__filter-content {\r\n  display: none;\r\n  position: absolute;\r\n  background-color: #E4E4E4;\r\n  min-width: 218px;\r\n  overflow: auto;\r\n  border: 1px solid #ddd;\r\n  border-radius: 6px;\r\n  z-index: 1;\r\n  &--active {\r\n    display: block;\r\n  }\r\n}",".cardWrapper {\r\n  max-height: 100vh;\r\n}\r\n\r\n.bigCard{\r\n  position: fixed;\r\n  top: -130%;\r\n  left: 50%;\r\n  transform: translate(-50%, 0);\r\n  width: 460px;\r\n  transition: 0.5s;\r\n  z-index: 1;\r\n  &--active{\r\n    top: 30px\r\n  }\r\n}\r\n\r\n.cardDescr {\r\n  background: #FFFFFF;\r\n  border-radius: 6px;\r\n  overflow: hidden;\r\n  width: 100%;\r\n  height: 100%;\r\n  &--reserve {\r\n    background: #208085;\r\n  }\r\n}\r\n\r\n.cardDescr__imgBlock {\r\n  width: 100%;\r\n  height: 400px;\r\n  &--reserve {\r\n    position: relative;\r\n    &::before{\r\n      content: \"\";\r\n      position: absolute;\r\n      width: 100%;\r\n      height: 100%;\r\n      background: linear-gradient(180deg, #208085 0%, rgba(32, 128, 133, 0.0001) 100%)\r\n    }\r\n  }\r\n  img{\r\n    width: 100%;\r\n    height: 100%;\r\n  }\r\n}\r\n\r\n.cardDescr__reserveText {\r\n  font-size: 24px;\r\n  left: 5%;\r\n  top: 5%\r\n}\r\n\r\n.cardDescr__bearsInfo {\r\n  padding: 20px 30px 30px 30px;\r\n  font-size: 13.2px;\r\n  max-height: 380px;\r\n  overflow-y: auto;\r\n  overflow-x: hidden\r\n}\r\n\r\n.cardDescr__bearName{\r\n  color: $color3F;\r\n  font-size: 24px;\r\n  margin-bottom: 7px;\r\n  &--reserve{\r\n    font-size: 24px;\r\n    margin-bottom: 7px;\r\n    color: $colorReserveFF\r\n  }\r\n}\r\n\r\n.cardDescr__bearTypeNGender {\r\n  color: $color76;\r\n  font-size: 18px;\r\n  &--reserve{\r\n    color: $colorReserveE7;\r\n    font-size: 18px;\r\n  }\r\n}\r\n\r\n.cardDescr__bearsInfo-descr {\r\n  margin-top: 16px;\r\n  color: $color76;\r\n  &--reserve{\r\n    margin-top: 16px;\r\n    color: $colorReserveE7\r\n  }\r\n}\r\n\r\n.cardDescr__btns {\r\n  display: flex;\r\n  justify-content: space-around;\r\n}\r\n\r\n.cardClose {\r\n  position: absolute;\r\n  top: -0.5%;\r\n  left: 102%;\r\n  cursor: pointer;\r\n  width: 25px;\r\n  height: 25px;\r\n  &::before{\r\n    @include cross;\r\n    transform: rotate(45deg)\r\n  }\r\n  &::after{\r\n    @include cross;\r\n    transform: rotate(-45deg)\r\n  }\r\n  &:hover::before{\r\n    transform: rotate(-45deg);\r\n    background: indianred\r\n  }\r\n  &:hover::after {\r\n    transform: rotate(-135deg);\r\n    background: indianred\r\n  }\r\n}","footer {\r\n  width: 100%;\r\n  height: 40px;\r\n  background: #0E4447;\r\n  padding: 12px 290px;\r\n}\r\n\r\nfooter div {\r\n  font-size: 14px;\r\n  text-align: center;\r\n  color: #F4F4F4;\r\n}","@media (max-width: 1199px) {\n  header {\n    padding-left: 30px;\n  }\n  .container {\n    padding: 20px 100px 0 100px;\n  }\n}\n\n@media (max-width: 991px) {\n  .wrapperForNavigation {\n    align-items: center;\n  }\n\n  .container {\n    padding: 20px 50px 0 50px;\n  }\n\n  .btn--accept {\n    width: 160px;\n    height: 28px;\n    font-size: 13px;\n  }\n\n  .btn--reject {\n    width: 160px;\n    height: 28px;\n    font-size: 13px;\n  }\n\n  .requests {\n    &__promo {\n      font-size: 18px;\n    }\n    &__reserve {\n      margin-right: 20px;\n    }\n    &__text {\n      font-size: 13px;\n    }\n    &__cards {\n      margin-top: 25px;\n    }\n    &__bearName {\n      font-size: 16px;\n    }\n    &__bearTypeNGender {\n      font-size: 12px;\n    }\n    &__reserveText {\n      left: 20%;\n      font-size: 17px;\n    }\n    &__filter-button {\n      width: 190px;\n    }\n    &__button-text {\n      font-size: 13px;\n    }\n    &__filter-content {\n      min-width: 190px;\n    }\n    &__filter-node {\n      font-size: 13px;\n    }\n    &__cards-card {\n      height: 360px;\n      width: 200px;\n    }\n    &__cards-descr {\n      padding-top: 10px\n    }\n  }\n\n  footer {\n    padding: 12px 230px;\n  }\n}\n\n@media (max-width: 767px) {\n  header {\n    padding-left: 5px;\n  }\n\n  .container {\n    padding: 20px 25px 0 25px;\n  }\n\n  .requests {\n    min-height: calc(100vh - 90px);\n    &__promo {\n      font-size: 16px;\n    }\n    &__reserve {\n      margin-right: 10px;\n    }\n    &__text {\n      font-size: 12px;\n    }\n    &__filter-button {\n      width: 160px;\n      height: 28px;\n    }\n    &__button-text {\n      font-size: 12px;\n      padding: 3px;\n    }\n    &__filter-content {\n      min-width: 160px;\n    }\n    &__filter-node {\n      font-size: 12px;\n    }\n    &__cards-card {\n      height: 380px;\n      width: 230px;\n    }\n    &__cards-imgBlock {\n      height: 190px;\n    }\n  }\n\n  footer {\n    padding: 8px 145px;\n    height: 30px;\n    div {\n      font-size: 12px;\n    }\n  }\n}\n\n@media (max-width: 575px) {\n\n  .hamburger {\n    display: block;\n  }\n\n  .hamburgerFilter {\n    display: flex\n  }\n\n  .wrapperForReserve {\n    display: none\n  }\n\n  .wrapperForNavigation {\n    display: block;\n    text-align: center;\n  }\n\n  .container {\n    padding: 15px 5px 0 5px;\n  }\n\n  .requests {\n    &__promo {\n      position: relative;\n      font-size: 8vw;\n      background: linear-gradient(to left, #f69ec4, #f9dd94 100%);\n      background-position: 0 100%;\n      background-size: 100% 4px;\n      background-repeat: repeat-x;\n    }\n    &__cards {\n      width: 100%;\n      flex-direction: column;\n      align-items: center;\n    }\n    &__cards-card {\n      margin-right: 10px;\n    }\n    &__reserveText {\n      font-size: 20px;\n    }\n    &__bearName {\n      font-size: 25px;\n    }\n    &__bearTypeNGender {\n      font-size: 16px;\n    }\n    &__cards-btns {\n      margin-top: 20px;\n      .btn--accept, .btn--reject {\n        width: 180px;\n        height: 32px;\n        font-size: 15px;\n      }\n    }\n  }\n\n  .bigCard {\n    width: 80vw;\n  }\n\n  .cardDescr__imgBlock {\n    height: 40vh;\n  }\n\n  .cardDescr__bearsInfo {\n    max-height: 40vh;\n    padding: 5px 20px 5px 20px;\n    font-size: 11.2px;\n  }\n\n  .cardDescr__bearName {\n    font-size: 22px;\n  }\n\n  .cardDescr__bearTypeNGender {\n    font-size: 16px;\n  }\n\n  .cardDescr__btns {\n    padding-top: 10px;\n    .btn--accept, .btn--reject {\n      width: 40%;\n      height: 30px;\n      font-size: 13px;\n    }\n  }\n\n  footer {\n    padding: 9px 35px;\n    div {\n      font-size: 10px\n    }\n  }\n\n}\n\n@media (max-width: 469px){\n  .requests__cards-card{\n    margin-right: 0;\n  }\n}"],"sourceRoot":""}]);
// Exports
...
"use strict";
module.exports = __webpack_require__.p + "assets/3927fa2a37e6f7f4c7c0.ttf";
...
/* harmony import */ var _reRender__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./reRender */ "./src/js/reRender.js");
/* harmony import */ var _allFilters__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./allFilters */ "./src/js/allFilters.js");
...
(0,_fetchData__WEBPACK_IMPORTED_MODULE_1__.getBearsData)().then(function () {
  ...
  (0,_reRender__WEBPACK_IMPORTED_MODULE_3__.cardFunctional)();
  (0,_allFilters__WEBPACK_IMPORTED_MODULE_4__.clickOnBothFilter)();
});
})();

/******/ })()
;
//# sourceMappingURL=main.c5a4c2cd2c2d8ac4549f.js.map